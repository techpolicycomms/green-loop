...
export const metadata: Metadata = {
  title: "Privacy Policy Â· LÃ©manLoop",
  description: "How LÃ©manLoop collects, uses, and protects your personal data in accordance with the Swiss nDSG and the EU GDPR."
};

const LAST_UPDATED = "23 February 2026";
const CONTROLLER = "LÃ©manLoop";
      ...
      <div style={{ maxWidth: 720 }}>
        ...
        <div className="policy-body">
          ...
          <Section title="1. Who we are">
            <p>
              <strong>{CONTROLLER}</strong> (&ldquo;we&rdquo;, &ldquo;us&rdquo;, &ldquo;our&rdquo;) operates the LÃ©manLoop platform, a circular lanyard programme serving Geneva&rsquo;s event ecosystem. Our registered address is {CONTROLLER_ADDRESS}.
            </p>
            <p>
          ...
          <Section title="3. Legal basis for processing">
            ...
            <ul>
              <li><strong>Contract performance</strong> â processing your account and activity data to provide the services you have signed up for.</li>
              <li><strong>Legitimate interests</strong> â server logs for security monitoring and abuse prevention; aggregated impact statistics for environmental reporting.</li>
              <li><strong>Consent</strong> â GPS location data at check-in (you must explicitly trigger a check-in). You may refuse without losing access to other features.</li>
              <li><strong>Legal obligation</strong> â retaining records required by Swiss accounting law (CO Art. 957 et seq.).</li>
            </ul>
          </Section>
          ...
          <Section title="4. How we use your data">
            <ul>
              ...
              <li>Calculating COâ savings and generating verified impact certificates for organisers</li>
          ...
          <Section title="5. Data sharing and processors">
            ...
            <Table rows={[
              ["Supabase Inc.", "Database hosting and authentication (PostgreSQL + Auth)", "EU/US â Standard Contractual Clauses"],
              ["Vercel Inc.", "Platform hosting and edge delivery", "EU/US â Standard Contractual Clauses"],
          ...
          <Section title="6. Data retention">
            ...
            <p>You may request earlier deletion where no legal retention obligation applies â see Section 7.</p>
          </Section>
          ...
          <Section title="7. Your rights">
            ...
            <ul>
              <li><strong>Access</strong> â obtain a copy of your personal data.</li>
              <li><strong>Rectification</strong> â correct inaccurate data.</li>
              <li><strong>Erasure</strong> â request deletion of your data (subject to legal retention obligations).</li>
              <li><strong>Restriction</strong> â ask us to pause processing in certain circumstances.</li>
              <li><strong>Data portability</strong> â receive your data in a structured, machine-readable format.</li>
              <li><strong>Objection</strong> â object to processing based on legitimate interests.</li>
              <li><strong>Withdrawal of consent</strong> â withdraw consent (e.g. for GPS check-in) at any time without penalty.</li>
            </ul>
            <p>
          ...
          <Section title="9. Cookies and local storage" id="cookies">
            ...
            <Table rows={[
              ["Session cookie", "sb-* (Supabase)", "Strictly necessary â authenticates your session. Cannot be disabled.", "Session"],
              ["CSRF token", "sb-auth-token", "Strictly necessary â protects against cross-site request forgery.", "Session"],
          ...
          <Section title="10. Children's data">
            <p>
              LÃ©manLoop is not directed at children under 16. We do not knowingly collect data from anyone under 16. If you believe a child has provided us with personal data, please contact us at <a href={`mailto:${CONTACT_EMAIL}`}>{CONTACT_EMAIL}</a> and we will delete it promptly.
            </p>
          </Section>
          ...
          <Section title="11. Security">
            <p>
              We apply industry-standard safeguards including TLS encryption in transit, AES-256 encryption at rest, row-level security policies on all database tables, and regular security reviews. However, no system is perfectly secure â please use a strong, unique password and contact us immediately if you suspect unauthorised access.
            </p>
          </Section>
...
// ââ Small shared components ââââââââââââââââââââââââââââââââââââââââââââââââ
