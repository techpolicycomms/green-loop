  ...
  return (
    <main>
      ...
      <header style={{ marginBottom: 28 }}>
        ...
        <p style={{ color: "var(--color-text-muted)", fontSize: 14, margin: "0 0 12px" }}>
          Full platform oversight for LémanLoop Geneva. All actions are logged.
        </p>
        <Link href="/admin/emissions" style={{ fontSize: 13, color: "var(--color-primary)", fontWeight: 600 }}>
          Green ICT emissions manager →
        </Link>
      </header>
