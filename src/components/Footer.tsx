      ...
      <div style={{
        ...
        >
          ...
          <div>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 8 }}>
              ...
              <Link href="/transparency" style={{ fontSize: 13, color: "var(--color-text-muted)", textDecoration: "none" }}>Green ICT transparency</Link>
            </div>
          </div>
        ...
        <div style={{
          ...
          <div style={{ display: "flex", gap: 20, flexWrap: "wrap" }}>
            ...
            <Link href="/privacy#cookies" style={{ fontSize: 12, color: "var(--color-text-subtle)", textDecoration: "none" }}>Cookies</Link>
